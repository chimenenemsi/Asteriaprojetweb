...
<div class="programs-page">
    ...
    <section class="coach-ai-wrap" id="coach-ai" aria-label="Asteria AI Coach">
        <span class="monta-eyebrow" style="background: rgba(108,161,56,0.2); color: #fff;">AI Coach</span>
...
(() => {
    ...
    const ask = async (prompt) => {
        ...
        try {
            ...
            append(data.response || data.error || 'Coach is busy. Try again.', 'bot');
        } catch (e) {
            append('Connection error with the coach.', 'bot');
        } finally {
    ...
    document.querySelectorAll('.coach-chip').forEach(c => {
        c.addEventListener('click', () => ask(c.dataset.coachPrompt));
    });
})();
</script>