...
<div class="consultation-front">
    <section class="hero">
        <div>
            <span class="monta-eyebrow">Client Consultation</span>
            ...
            <div class="monta-actions">
                <a class="monta-button secondary" href="mailto:info@example.com?subject=I%20want%20a%20consultation">Talk with Asteria</a>
            </div>
        </div>
    ...
    <section class="monta-section" id="consultation-cards">
        <div class="section-head">
            <div>
                <span class="monta-eyebrow">Live Offers</span>
                ...
                <?php foreach ($consultations as $consultation): ?>
                    ...
                    <article class="package-card">
                        ...
                        <div class="package-footer">
                            ...
                            <a class="monta-button" href="mailto:info@example.com?subject=<?= htmlspecialchars(rawurlencode($mailSubject), ENT_QUOTES, 'UTF-8') ?>">Request this session</a>
                        </div>
                    </article>
                <?php endforeach; ?>
            </div>
    ...
    <section class="monta-section">
        <div class="section-head">
            <div>
                <span class="monta-eyebrow">How It Works</span>
    ...
    <section class="monta-section">
        <div class="section-head">
            <div>
                <span class="monta-eyebrow">Client Experience</span>
