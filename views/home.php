<section class="chimene-section">
    <div class="chimene-hero">
        <div>
            <span class="chimene-eyebrow">Produits Module</span>
            ...
            <div class="chimene-actions">
                <a class="chimene-button" href="<?= htmlspecialchars(route_url('frontoffice/categories'), ENT_QUOTES, 'UTF-8') ?>">Open Categories</a>
                <a class="chimene-button secondary" href="<?= htmlspecialchars(route_url('frontoffice/products'), ENT_QUOTES, 'UTF-8') ?>">Open Products</a>
            </div>
        </div>
        <div class="chimene-hero-visual">
...
<section class="chimene-section">
    <div class="chimene-grid">
        <div class="chimene-card">
