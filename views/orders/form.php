...
<div class="card">
    <form method="post" action="<?= htmlspecialchars($action, ENT_QUOTES, 'UTF-8') ?>" novalidate class="form-shell">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="field">
                        ...
                        <select name="product_id" id="order-product-select">
                            ...
                            <?php foreach (($products ?? []) as $product): ?>
                                ...
                                >
                                    <?= htmlspecialchars((string) $product['name'], ENT_QUOTES, 'UTF-8') ?> - DT <?= htmlspecialchars(number_format((float) $product['price'], 2), ENT_QUOTES, 'UTF-8') ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-3">
                    <div class="field">
                        ...
                        <input type="text" inputmode="decimal" id="order-quantity-input" name="quantity" value="<?= htmlspecialchars((string) ($values['quantity'] ?? 1), ENT_QUOTES, 'UTF-8') ?>">
        ...
        <div class="form-section">
            ...
            <p>Collect the contact and delivery information for the order. The logged-in user account is stored with the order automatically.</p>
            <?php if (!empty($values['user_id']) || !empty($_SESSION['user']['id'])): ?>
                <?php
                $displayUserId = $values['user_id'] ?? $_SESSION['user']['id'];
                $displayUserName = $values['user_fullname'] ?? $_SESSION['user']['fullname'] ?? '';
                $displayUserEmail = $values['user_email'] ?? $_SESSION['user']['email'] ?? '';
                ?>
                <div class="summary-item" style="margin-bottom:16px">
                    <strong>User Account</strong>
                    <span>
                        #<?= htmlspecialchars((string) $displayUserId, ENT_QUOTES, 'UTF-8') ?>
                        <?= $displayUserName !== '' ? ' - ' . htmlspecialchars((string) $displayUserName, ENT_QUOTES, 'UTF-8') : '' ?>
                        <?= $displayUserEmail !== '' ? ' (' . htmlspecialchars((string) $displayUserEmail, ENT_QUOTES, 'UTF-8') . ')' : '' ?>
                    </span>
                </div>
            <?php endif; ?>
            <div class="row">
                <div class="col-5">
                    <div class="field">
                        ...
                        <input id="customer-name" type="text" name="customer_name" placeholder="Customer full name" value="<?= htmlspecialchars((string) ($values['customer_name'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
                ...
                <div class="col-7">
                    <div class="field">
                        ...
                        <input id="customer-email" type="text" inputmode="email" name="customer_email" placeholder="name@example.com" value="<?= htmlspecialchars((string) ($values['customer_email'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <textarea id="shipping-address" name="shipping_address" rows="4" placeholder="Street, area, city, and anything needed for delivery"><?= htmlspecialchars((string) ($values['shipping_address'] ?? ''), ENT_QUOTES, 'UTF-8') ?></textarea>
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <textarea id="order-notes" name="notes" rows="4" placeholder="Special delivery notes or order comments"><?= htmlspecialchars((string) ($values['notes'] ?? ''), ENT_QUOTES, 'UTF-8') ?></textarea>
            ...
            <div class="delivery-map-shell">
                <div class="delivery-map-toolbar">
                    <div class="field" style="flex:1 1 260px">
                        ...
                        <input id="delivery-location-name" type="text" name="delivery_location_name" placeholder="Pin a spot on the map or type a short label" value="<?= htmlspecialchars((string) ($values['delivery_location_name'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
                    </div>
                </div>
        ...
        <div class="form-section">
            ...
            <div class="summary-grid">
                ...
                <div class="summary-item">
                    ...
                    <span id="order-price-display"><?= htmlspecialchars(($values['unit_price'] ?? '') === '' ? 'Calculated from product' : ('DT ' . number_format((float) $values['unit_price'], 2)), ENT_QUOTES, 'UTF-8') ?></span>
                </div>
                <div class="summary-item">
                    <strong>Total</strong>
                    <span id="order-total-display"><?= htmlspecialchars(($values['total_amount'] ?? '') === '' ? 'Calculated from quantity' : ('DT ' . number_format((float) $values['total_amount'], 2)), ENT_QUOTES, 'UTF-8') ?></span>
                </div>
                <div class="summary-item">
