        ...
        <div class="col-xxl-4" id="consultation-form">
            <div class="card editor-card h-100">
                <div class="card-body p-4">
                    ...
                    <form method="post" action="<?= htmlspecialchars(route_url('backoffice/consultation'), ENT_QUOTES, 'UTF-8') ?>">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="consultation-spots" name="spots" type="number" min="1" value="<?= htmlspecialchars((string) $formData['spots'], ENT_QUOTES, 'UTF-8') ?>">
                            </div>
                        </div>
                                ...
                                <div class="card-body p-4 d-flex flex-column">
                                    ...
                                    <div class="card-footer-line">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <form method="post" action="<?= htmlspecialchars(route_url('backoffice/consultation'), ENT_QUOTES, 'UTF-8') ?>" onsubmit="return confirm('Delete this consultation card?');">
