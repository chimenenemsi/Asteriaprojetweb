...
.records-hero{padding:28px;border-radius:28px;background:radial-gradient(circle at top right,#fef3c7 0%,#eff6ff 35%,#ffffff 75%);border:1px solid #d9e2f2;box-shadow:0 22px 60px rgba(15,23,42,.08)}
.records-hero h1{margin:0;color:#0f172a}
.records-hero-copy{max-width:760px;color:#475569;line-height:1.7;margin-top:10px}
.records-stat-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px}
.records-stat-card{padding:20px;border-radius:22px;background:linear-gradient(180deg,#ffffff 0%,#f8fbff 100%);border:1px solid #dbe7f3;box-shadow:0 16px 40px rgba(15,23,42,.06)}
.records-stat-card strong{display:block;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#64748b}
.records-stat-card span{display:block;font-size:32px;font-weight:800;color:#0f172a;margin-top:8px}
.records-stat-card small{display:block;margin-top:8px;color:#475569;line-height:1.5}
...
.records-chart-card h2{margin:0;color:#0f172a;font-size:20px}
.records-chart-card p{margin:10px 0 0;color:#64748b;line-height:1.6}
...
.record-card h3{margin:0;color:#0f172a;font-size:20px;line-height:1.3}
.record-card p{margin:0;color:#475569;line-height:1.6}
.record-chip{display:inline-flex;align-items:center;padding:7px 11px;border-radius:999px;background:#eff6ff;color:#1d4ed8;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.06em}
...
.record-meta-item strong{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.08em;color:#64748b}
.record-meta-item span{display:block;margin-top:6px;font-weight:700;color:#0f172a}
.record-card .actions{display:flex;gap:10px;flex-wrap:wrap}
.record-empty{padding:28px;color:#64748b}
