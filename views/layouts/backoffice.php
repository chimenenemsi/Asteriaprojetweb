...
<head>
    ...
    <style>
        .chimene-brand-label{display:inline-flex;align-items:center;gap:12px;font-weight:700;color:#1f2937;text-decoration:none}
        .chimene-brand-label img{display:block;width:42px;height:auto}
        .chimene-sidebar-caption{margin:12px 20px 6px;font-size:12px;font-weight:700;letter-spacing:.08em;color:#94a3b8;text-transform:uppercase}
        ...
        .logo-box .chimene-logo-word{font-size:22px;font-weight:700;line-height:1}
        .logo-box .logo-light .chimene-logo-word{color:#fff}
        .logo-box .logo-dark .chimene-logo-word{color:#1f2937}
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                        ...
                        <li class="d-none d-lg-block">
                            <a class="chimene-brand-label" href="<?= htmlspecialchars(route_url('backoffice/dashboard'), ENT_QUOTES, 'UTF-8') ?>">
        ...
        <div class="app-sidebar-menu">
            <div class="h-100" data-simplebar>
                <div id="sidebar-menu">
                    <div class="logo-box">
                        <a class="logo logo-light" href="<?= htmlspecialchars(route_url('backoffice/dashboard'), ENT_QUOTES, 'UTF-8') ?>">
                            ...
                            <span class="logo-lg">
                                ...
                                <span class="chimene-logo-word">Asteria</span>
                            </span>
                        </a>
                    ...
                    <div class="chimene-sidebar-caption">Backoffice</div>
                    <ul id="side-menu">
