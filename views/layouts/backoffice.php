...
<head>
    ...
    <style>
        ...
        .logo-box .logo-light .brand-word {
            color: #ffffff;
        }

        .logo-box .logo-dark .brand-word {
            color: #1f2937;
        }
    </style>
</head>
                ...
                <div class="d-flex justify-content-between">
                    <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                        ...
                        <li class="d-none d-lg-block">
                            <a class="brand-label" href="<?= htmlspecialchars(route_url('backoffice/dashboard'), ENT_QUOTES, 'UTF-8') ?>">
                    ...
                    <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center"></ul>
                </div>
            </div>
        </div>
        ...
        <div class="app-sidebar-menu">
            <div class="h-100" data-simplebar>
                <div id="sidebar-menu">
                    <div class="logo-box">
                        <a class="logo logo-light" href="<?= htmlspecialchars(route_url('backoffice/dashboard'), ENT_QUOTES, 'UTF-8') ?>">
                            ...
                            <span class="logo-lg">
                                ...
                                <span class="brand-word">Asteria</span>
                            </span>
                        </a>
                    ...
                    <div class="sidebar-caption">Backoffice</div>
                    <ul id="side-menu">
                        <?php foreach ($navigation as $slug => $label): ?>
                            ...
                            <li>
                                <a class="tp-link <?= $currentRoute === $route ? 'active' : '' ?>" href="<?= htmlspecialchars(route_url($route), ENT_QUOTES, 'UTF-8') ?>">
                                    ...
                                    <?php if ($slug === 'user-management'): ?><i data-feather="users"></i><?php endif; ?>
                                    <?php if ($slug === 'meal-planning'): ?><i data-feather="clipboard"></i><?php endif; ?>
                                    <?php if ($slug === 'progress-tracking'): ?><i data-feather="activity"></i><?php endif; ?>
                                    <?php if ($slug === 'nutrition-blog'): ?><i data-feather="book-open"></i><?php endif; ?>
                                    <?php if ($slug === 'programs'): ?><i data-feather="layers"></i><?php endif; ?>
