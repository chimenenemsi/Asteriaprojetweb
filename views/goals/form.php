...
<div class="card">
    <div class="header-line">
        <div>
            ...
            <p class="muted"><?= $area === 'frontoffice' ? 'Create or update a progress goal from frontoffice.' : 'Create or update a progress goal.' ?></p>
        </div>
...
<div class="card">
    <form method="post" action="<?= htmlspecialchars($action, ENT_QUOTES, 'UTF-8') ?>" class="form-shell" novalidate>
            ...
            <div class="row">
                <div class="col-3">
                    <div class="field">
                        ...
                        <input id="goal-start-value" type="text" name="start_value" placeholder="Example: 90.5" value="<?= htmlspecialchars((string) ($values['start_value'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
                ...
                <div class="col-3">
                    <div class="field">
                        ...
                        <input id="goal-target-value" type="text" name="target_value" placeholder="Example: 75.0" value="<?= htmlspecialchars((string) ($values['target_value'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
        ...
        <div class="actions">
            ...
            <?php if ($mode === 'edit' && $area === 'backoffice'): ?>
