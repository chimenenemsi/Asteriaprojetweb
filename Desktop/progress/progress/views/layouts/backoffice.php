...
<body data-menu-color="light" data-sidebar="default">
    ...
    $switchRoute = in_array($section, ['goals', 'records'], true) ? 'frontoffice/' . $section : 'frontoffice/home';
    ?>
    <div id="app-layout">
            ...
            <div class="container-fluid">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap">
                        <a class="module-switch" href="<?= htmlspecialchars(route_url('frontoffice/ai-survey'), ENT_QUOTES, 'UTF-8') ?>">Open AI Survey</a>
                        ...
                        <?php foreach (backoffice_navigation() as $slug => $label): ?>
                            ...
                            <li>
                                <a class="tp-link <?= $currentRoute === $route ? 'active' : '' ?>" href="<?= htmlspecialchars(route_url($route), ENT_QUOTES, 'UTF-8') ?>">
                                    ...
                                    <?php if ($slug === 'records'): ?><i data-feather="activity"></i><?php endif; ?>
