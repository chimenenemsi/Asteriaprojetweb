...
<div class="card">
    <form method="post" action="<?= htmlspecialchars($action, ENT_QUOTES, 'UTF-8') ?>" novalidate class="form-shell" id="record-form">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="field">
                        ...
                        <input id="record-value" type="text" inputmode="decimal" name="recorded_value"
                ...
                <div class="col-6">
                    <div class="field">
                        ...
                        <div class="adherence-wrapper">
                            ...
                            <input id="adherence-score" type="text" inputmode="decimal" name="adherence_score"
